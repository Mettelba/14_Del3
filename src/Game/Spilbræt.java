...
public class Spilbræt {
	...
	private void initialiserSpilBræt(Spiller[] spiller) {	
		...
		felter[0] = new StartFelt(0, 0, 7, 0, "Du har passeret start og får 2 Kr ", "START!", 2);
		...
		c.setSubText(String.valueOf(felter[2].hentPris())+ " Kr ");
		guifelter[2] = c;
		...
		g.setSubText(String.valueOf(felter[5].hentPris())+ " Kr");
		guifelter[5] = g;
		...
		j.setSubText(String.valueOf(felter[8].hentPris())+ " Kr");
		guifelter[8] = j;
		...
		m.setSubText(String.valueOf(felter[10].hentPris()) + " Kr");
		guifelter[11] = m;
		...
		p.setSubText(String.valueOf(felter[14].hentPris())+ " Kr");
		guifelter[14] = p;
		...
		y.setSubText(String.valueOf(felter[23].hentPris())+ " Kr");
		guifelter[23] = y;
